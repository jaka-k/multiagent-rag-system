      ...
      <TableCell className="text-right">
        {(() => {
          switch (currentStep) {
            case 'processing':
              return (
                <div className="bg-purple-500 text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium">
            ...
            case 'embedding':
              return (
                <div className="bg-indigo-500 text-primary-foreground h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium">
            ...
            case 'completed':
              return (
                <div className="bg-green-500 text-primary-foreground h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium">
            ...
            case 'failed':
              return (
                <div className="bg-red-600 text-primary-foreground h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium">
